...
return [
    ...
    'POST <module>/users/password-reset-token-verification' => '<module>/user/password-reset-token-verification',
    ...
    'GET <module>/records/<alias:sources|overview|analysis|reimbursement-statuses>' => '<module>/record/<alias>',
